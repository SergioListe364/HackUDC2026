...
class NoteRequest(BaseModel):
    ...
    lang: Optional[str] = "es"       # Idioma de salida: 'es' | 'en'
...
class SummarizeRequest(BaseModel):
    """Petición de resumen automático de un grupo/subgrupo."""
    group:    str
...
class SummarizeResult(BaseModel):
    """Resumen generado por la IA para un grupo/subgrupo."""
    group:    str
    subgroup: Optional[str] = None
    summary:  str
...
class ClassificationResult(BaseModel):
    ...
    action: str = "add"                 # "add", "delete", "remind"
    ...
    remind_at: Optional[str] = None     # ISO datetime para recordatorios, ej. "2026-03-03T16:30:00"
    ...
    url: Optional[str] = None           # URL detectada en la nota original (propagada al backend)
